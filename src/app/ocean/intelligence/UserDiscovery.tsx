        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <Avatar
              ...
              className="h-14 w-14 ring-2 ring-blue-200 group-hover:ring-blue-400 transition-all duration-300"
            />
            <span className="absolute -bottom-1 -right-1 w-4 h-4 bg-green-400 rounded-full border-2 border-white flex items-center justify-center shadow">
