      ...
      <div className="w-full max-w-6xl mx-auto px-2">
        ...
        <div className="flex flex-col items-center mb-4">
          <div className="flex items-center gap-2 bg-white rounded-full px-3 py-1 mb-2 shadow-sm border border-blue-100">
            ...
            <span className="text-xs font-medium text-gray-700">File Utility</span>
          </div>
          ...
          <CardContent className="p-3 pt-1">
            {id ? (
              <div className="flex flex-col items-center gap-1 text-xs text-gray-700 bg-white rounded-md border border-blue-100 px-4 py-3 shadow-sm">
                ...
                <span className="text-[11px] text-gray-400 mt-0.5">Will expire in 8 hours</span>
              ...
              <>
                <div className="rounded-md overflow-hidden border border-blue-100 mb-2">
                  {zipFile ? (
                    <div className="flex flex-col items-center justify-center w-full py-6 px-4 bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-dashed border-blue-200 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        <FileText className="w-5 h-5 text-blue-500" />
                        <span className="text-sm font-medium text-blue-700">{zipFile.name}</span>
                      ...
                      <Button
                        className="cursor-pointer h-8 text-xs bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold transition-all duration-150"
                        onClick={handleSave}
                        disabled={isLoading}
                      >
                        {isLoading ? (
                    ...
                    <label
                      htmlFor="file-upload"
                      className="flex flex-col items-center justify-center w-full h-36 cursor-pointer bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-dashed border-blue-200 rounded-lg hover:bg-blue-100 transition group"
                    >
                      <svg
                        className="w-10 h-10 mb-2 text-blue-400 group-hover:text-blue-600 transition"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        viewBox="0 0 24 24"
